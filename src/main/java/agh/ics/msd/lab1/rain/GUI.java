...
public class GUI extends JPanel implements ActionListener{
	...
	public void initialize(Container container) {
		...
		pred.addChangeListener(this::simulationSpeedChangeListener);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(timer)) {
			iterNum++;
			frame.setTitle("Game of Life (" + iterNum + " iteration)");
			board.iteration();
		} else {
	 ...
	 */
	private void simulationSpeedChangeListener(ChangeEvent e) {
